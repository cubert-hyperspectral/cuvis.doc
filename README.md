...
This Repository contains the code for generating the documentation of the Cuvis software.

The current version can be found [here](https://cubert-hyperspectral.github.io/cuvis.doc/)
